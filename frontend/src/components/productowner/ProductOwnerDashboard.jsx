...
const ProductOwnerDashboard = () => {
    ...
    const fetchDashboardData = async (projectId) => {
        try {
            ...
            const [backlogStats, epicStats, releaseStats, recentItems, recentEpics] = await Promise.all([
                fetch(`http:
                    headers: { 'Authorization': `Bearer ${token}` }
            ...
            upcomingReleases: [
                {
                    id: 1,
                    name: 'v1.2.0',
                    plannedReleaseDate: '2025-02-15',
                    status: 'IN_PROGRESS'
                },
                {
                    id: 2,
                    name: 'v1.3.0',
                    plannedReleaseDate: '2025-03-30',
                    status: 'PLANNED'
                }
            ]
        });
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                    ...
                    <div className="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <div className="flex justify-between text-xs">
                            <span className="text-green-600">{dashboardData.backlogStats.readyItems || 0} Ready</span>
                            <span className="text-blue-600">{dashboardData.backlogStats.newItems || 0} New</span>
                        </div>
                    ...
                    <div className="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <div className="flex justify-between text-xs">
                            <span className="text-green-600">{dashboardData.epicStats.completedEpics || 0} Done</span>
                            <span className="text-blue-600">{dashboardData.epicStats.inProgressEpics || 0} Active</span>
                        </div>
                    ...
                    <div className="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <div className="flex justify-between text-xs">
                            <span className="text-green-600">{dashboardData.releaseStats.completedReleases || 0} Released</span>
                            <span className="text-blue-600">{dashboardData.releaseStats.inProgressReleases || 0} Active</span>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                    ...
                    <div className="bg-white rounded-lg shadow-sm">
                        <div className="flex items-center justify-between p-6 border-b border-gray-200">
                            <h3 className="text-lg font-semibold text-gray-800">Recent Backlog Items</h3>
                            <button
                                onClick={() => navigate('/productowner/backlog')}
                    ...
                    <div className="bg-white rounded-lg shadow-sm">
                        <div className="flex items-center justify-between p-6 border-b border-gray-200">
                            <h3 className="text-lg font-semibold text-gray-800">Active Epics</h3>
                            <button
                                onClick={() => navigate('/productowner/epics')}
                                className="text-primary hover:text-hoverBlue flex items-center text-sm"
                            >
                            ...
                            {dashboardData.recentEpics.length > 0 ? (
                                <div className="space-y-3">
                                    {dashboardData.recentEpics.map((epic) => (
                                        <div key={epic.id} className="flex items-center justify-between p-3 bg-purple-50 rounded-lg">
                                            <div className="flex-1">
                                                <h4 className="font-medium text-gray-800 mb-1">{epic.title}</h4>
                                                <div className="flex items-center gap-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        ...
                        >
                            ...
                            <div className="text-left">
                                ...
                                <div className="text-sm text-purple-700">Group related stories</div>
                            </div>
                        </button>
                        <button
                            onClick={() => navigate('/productowner/releases')}
